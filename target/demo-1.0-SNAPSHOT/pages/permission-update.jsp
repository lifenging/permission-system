...
<body class="hold-transition skin-purple sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form action="${pageContext.request.contextPath}/permission/update"
				method="post">
				<input type="hidden" name="parentName" id="parentName" value="${permission.parentName}">
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<select name="parentId"
									onchange="document.getElementById('parentName').value=this.options[this.selectedIndex].text">
								<option value="" selected>请选择</option>
								<c:forEach var="p" items="${permissionList}">

									<option value="${p.permissionId}"
										${permission.permissionId == p.permissionId ? 'selected': ''}>${p.permissionName}</option>
								</c:forEach>
							</select>
						</div>

						<div class="col-md-2 title">菜单URL</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="url"
								placeholder="菜单URL" value="${permission.url}">
						</div>

						<div class="col-md-2 title">菜单级别</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="level"
								placeholder="菜单级别" value="${permission.level}">
						</div>
