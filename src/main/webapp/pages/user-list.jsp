			...
			<!-- 内容头部 /-->
				...
				<div class="box box-primary">
									...
									<c:forEach items="${pageInfo.getList()}" var="user">
										<tr>
											...
											<td class="text-center">
												...
												<a href="${pageContext.request.contextPath}/user/toUpdate?id=${user.id}" class="btn bg-olive btn-xs">修改</a>
												<a href="${pageContext.request.contextPath}/user/userRole?id=${user.id}" class="btn bg-olive btn-xs">添加角色</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
					...
					<jsp:include page="pages.jsp">
						<jsp:param name="pageUrl" value="/user/pageInfo"/>
					</jsp:include>
					<!-- /.box-footer-->
